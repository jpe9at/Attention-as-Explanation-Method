...
save_path = args.path_to_save +'_imdb.pth'
#save_path_parameters = args.path_to_save + '_imdb_parameters.pth'
...
model = BERTClassifier('prajjwal1/bert-tiny', 1, learning_rate=0.01, optimizer = 'SGD', loss_function = 'BCE' ).to(device)
