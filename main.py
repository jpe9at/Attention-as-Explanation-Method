...
use_saved_model = args.saved
if use_saved_model:
    print("Use saved model:", use_saved_model)
...
test_dataset = TextData(X_test[-1000:], y_test[-1000:], tokenizer, max_length=25, train=False)
...
# Set the model to evaluation mode (important for inference)
    ...
    #print(f"roc_auc Accuracy is: {roc_auc}")
